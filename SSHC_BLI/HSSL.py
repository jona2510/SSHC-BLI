...
#from SSHC_BLI.LCN import TopDownMPP as tdm
from SSHC_BLI.LCN import LCN
...
from SSHC_BLI.utils import SISI
...
class SSHCBLI(SS_LCN):
	"""
	(S)emi-(S)upervised (H)ierarchical (C)lassifier (B)ased on (L)ocal (I)nformation (SSHMC-BLI)
	"""
	...
	"""	
	#def __init__(self,H,Hclassifier=None,policy=None,classifiers_strategy="from_scratch",unlabeled_strategy="all",strategy_bestU="naiveThreshold",threshold=0.7,minUdata=10,maxIterations=-1,seed=0):
	def __init__(self,H,Hclassifier=None,policy=None,classifiers_strategy="from_scratch",variant="v1",threshold=0.7,minUdata=10,maxIterations=-1,seed=0,k=3,t2considerNode=0,inck=10,converge=0,metric='euclidean'):
